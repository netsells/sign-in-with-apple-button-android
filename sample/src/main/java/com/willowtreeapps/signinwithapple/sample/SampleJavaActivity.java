...
public class SampleJavaActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    SignInWithAppleButton signInWithAppleButtonWhiteOutline =
    ...
    SignInWithAppleConfiguration configuration =
        new SignInWithAppleConfiguration.Builder()
            .clientId("com.your.client.id.here")
            .redirectUri("https://your-redirect-uri.com/callback")
            .scope("email name")
            .build();

    SignInWithAppleCallback callback =
        new SignInWithAppleCallback() {
          @Override
    ...
    signInWithAppleButtonBlack.setUpSignInWithAppleOnClick(
        getSupportFragmentManager(), configuration, callback);
